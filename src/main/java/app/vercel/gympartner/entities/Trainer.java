...
public class Trainer extends User{
    ...
    public Trainer(int idUser, String name, String lastName, String email, String password, String gender, LocalDate birthDate, String cellphone, boolean status, Role role, double salary, LocalDate yearHired, Gym gym) {
